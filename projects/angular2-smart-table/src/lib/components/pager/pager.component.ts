  ...
  template: `
    <nav *ngIf="shouldShow()" class="angular2-smart-pagination-nav">
      <ul class="angular2-smart-pagination pagination">
        <li
          class="angular2-smart-page-item page-item"
          [ngClass]="{ disabled: getPage() == 1 }"
        >
          <a
            class="angular2-smart-page-link page-link"
            href="#"
        ...
        >
          <a
            class="angular2-smart-page-link page-link page-link-prev"
            href="#"
        ...
        >
          <span
            class="angular2-smart-page-link page-link"
            *ngIf="getPage() == page"
            >{{ page }} Current<span class="sr-only">(current)</span></span
          >
          <a
            class="angular2-smart-page-link page-link"
            href="#"
        ...
        >
          <a
            class="angular2-smart-page-link page-link page-link-next"
            href="#"
    ...
    <nav
      *ngIf="perPageSelect && perPageSelect.length > 0"
      class="angular2-smart-pagination-per-page"
    >
...
export class PagerComponent implements OnChanges {
  ...
  paginate(page: number): boolean {
    alert('Page loaded');
    console.log('This page is paginated : ', page);
